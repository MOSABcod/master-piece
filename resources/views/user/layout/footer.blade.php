        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2 mx-2 mb-2"></i>أخباراتنا</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2 mx-2 mb-2"></i>مدرستنا</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2 mx-2 mb-2"></i>رسالتناورؤيتنا</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2 mx-2 mb-2"></i>معلمونا</a>
                    <a class="text-white" href="#"><i class="fa fa-angle-right mr-2"></i>تسجيل الدخول</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
