...
<body>
    ...
    <header style="background-color: #27703b " class="bg-edblue ed-header--2 relative z-[2] px-[7.9%] xxxxl:px-[6.5%] xxxl:px-[1%] lg:px-[15px] py-[25px] xxs:py-[16px] flex items-center justify-between to-be-fixed">
        <div class="logo xxs:max-w-[40%] flex flex-row items-center"><a href="index.html"><img src="assets/img/logo 05 (1).jpeg" style="height: 74px;
" alt="logo"  class="logo">
</a>
وزارة التربية والتعليم- مدرسة زبدا الثانوية
